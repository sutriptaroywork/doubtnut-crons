...
async function sendNotification(allUsers, notifType) {
    ...
    if (notifType === "hourly_notif") {
        notificationPayload = {
            title: "Arey English se darr gaye kya! 🤥",
            message: "English practice se hi seekhi jaati hai dost! Wapas ajao! 😉",
            image: `${config.staticCDN}images/2022/02/13/18-57-03-291-PM_Entry%20Banner%20Correct.webp`,
            firebase_eventtag: "english_contest",
            event: "english_contest",
            data: {
                deeplink: "doubtnutapp://practice_english",
            },
        };
    } else if (notifType === "session_dropoff_notif") {
        notificationPayload = {
